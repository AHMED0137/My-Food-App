...
const EditButton = ({ selectedStudentInfo, setCompleteData }) => {
  const [open, setOpen] = React.useState(false);
  const handleOpen = () => setOpen(true);
  const handleClose = () => setOpen(false);
  const [foodInfo, setFoodInfo] = React.useState({});

  // set updated all data
  const getAllFood = () => {
  ...
  const updateData = async (e) => {
    ...
    await fetch(`/update/${selectedStudentInfo[0]._id}`, {
      method: "PATCH",
        ...
        <Box sx={style} className="model_in">
          ...
          >
            <Box sx={{ display: "flex", alignItems: "flex-end" }}>
              ...
              <TextField
                ...
                variant="standard"
                name="foodName"
                defaultValue={selectedStudentInfo[0]?.foodName}
            ...
            <FormControl variant="standard" sx={{ minWidth: 220 }}>
              ...
              <Select
                ...
                onChange={handleinput}
                defaultValue={selectedStudentInfo[0]?.category}
                label="Category"
                name="category"
              >
          ...
          >
            <Box sx={{ display: "flex", alignItems: "flex-end" }}>
              ...
              <TextField
                ...
                variant="standard"
                name="ingredients"
                defaultValue={selectedStudentInfo[0]?.ingredients}
                onChange={handleinput}
              />
            </Box>
            <Box sx={{ display: "flex", alignItems: "flex-end" }}>
              ...
              <TextField
                ...
                variant="standard"
                name="calories"
                defaultValue={selectedStudentInfo[0]?.calories}
                onChange={handleinput}
              />
            </Box>
          </Typography>
          ...
          >
            <Box sx={{ display: "flex", alignItems: "flex-end" }}>
              ...
              <TextField
                ...
                variant="standard"
                name="price"
                defaultValue={selectedStudentInfo[0]?.price}
                onChange={handleinput}
              />
            </Box>
            <Box sx={{ display: "flex", alignItems: "flex-end" }}>
              ...
              <TextField
                ...
                variant="standard"
                name="image"
                defaultValue={selectedStudentInfo[0]?.image}
                onChange={handleinput}
              />
            </Box>
          </Typography>
          ...
          >
            <TextField
              ...
              defaultValue={selectedStudentInfo[0]?.description}
              onChange={handleinput}
            />
          </Typography>
